...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> © 2020 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://mawanmahmud.github.io/portofolio/" target="_blank">Mawan Mahmud</a></div></div>
        </footer>
